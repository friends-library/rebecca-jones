...
so that the church, as a body, remained "`steadfast, unmovable,`" yet princes,
...
If you write to her or dear Rebecca Archer, please, with my love, tell them so.
...
So had dear Jane, and Gervase Johnson, the band of young ministers, etc.`"
